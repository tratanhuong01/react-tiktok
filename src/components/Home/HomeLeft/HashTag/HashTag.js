...
export default function HashTag() {
    return (
        <>
            <p className="pb-2 px-3 text-gray-600 font-semibold hidden md:flex">
                Explore
            </p>
            <ul className="p-3 border-b-2 border-solid border-gray-100  hidden md:flex flex-wrap">
                ...
                <li className="px-2 py-0.5 rounded-full mr-2 mb-2 text-sm font-semibold flex items-center border 
                border-solid border-gray-200 hover:bg-gray-100 cursor-pointer">
                    <i className='bx bxs-music mr-2'></i>
